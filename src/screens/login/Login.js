  ...
  loginClickHandler = () => {
    ...
    if (
      ...
      sessionStorage.setItem(
        "access-token",
        "IGQVJYT2lROWF5ZAUE5clpLV0YwRWE1M2xiOGxRYy1XVzZARODh6bFprNWh0akJlZA2JaNmhzNEQ5dHlDUmFLYk0xMHYyeE1JTDVONXpkbl9wMXBkOWRnZAWpPM1pGSmRxZAmloaGVUeVZAlVXp0OHN2YWRwVwZDZD"
      );
      this.setState({ incorrectUsernamePassword: "dispNone" });
